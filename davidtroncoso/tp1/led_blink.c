...
#define DDRB_OUT (0x24)
#define quintobit 0x20
#define HABILITA_OUT (0x25)
...
void ledInit(void)
{
volatile unsigned char * pepe = (volatile unsigned char *)DDRB_OUT;
*pepe= (*pepe) | 0x20;
}
...
volatile unsigned char * habilitaA = (volatile unsigned char *)HABILITA_OUT;

	while(1)
	{
	*habilitaA= (*habilitaA)^0x20;
