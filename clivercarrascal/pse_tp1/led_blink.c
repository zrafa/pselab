...
int main(void)
{
     ...
     * main(){
     * ...
     * *(volatile unsigned char *)myTRISB=0x20;//En la direccion que nos da myTRISB le ponemos el valor 0x20. Hay que hacer cast para asegurar que el puntero sea de 8 bits.
     *
     * }
     *
     * Paso 2:
  ...
  //printf("hello world!");
  DDRB=0x20;//DDRB=TRISB. Esta definido en avr/io.h
  while(1)
    {
      PORTB=0x20;
      _delay_ms(500);
