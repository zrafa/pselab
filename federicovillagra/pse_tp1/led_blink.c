...
//#define LED_GREEN (0x20) /*00100000*/
//#define PIN13_FUNC_GENERAL (0xFFFFCFFF)


int main(void){

	volatile unsigned char *puerto_b_ddr = 0x24;
	volatile unsigned char *puerto_b = 0x25;
	volatile unsigned double tiempo;
	*pueto_b_ddr = 0x20;
	while(1){	
	*puerto_b = 0x20;
	while (tiempo < 20000000);
	*puerto_b = 0x00;
	}
}
